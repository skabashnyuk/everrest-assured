 ...
 * of {@link org.mockito.MockitoAnnotations#initMocks(Object)} is not
 * necessary</strong>. Mocks are initialized before each test method.
 * <li>
 ...
 * working, for example by writing a base class. Explicitly validating framework
 * usage is also optional because it is triggered automatically by Mockito every
 * time you use the framework. See javadoc for
 * {@link Mockito#validateMockitoUsage()}.
 * <p>
